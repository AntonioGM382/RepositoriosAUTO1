...
namespace mobileWeb
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand com = new SqlCommand("SELECT * FROM ARTICULO AS art RIGHT JOIN MOVIL AS mov ON art.codigo = mov.codigo", c);
            SqlDataReader dr = com.ExecuteReader();

            while (dr.Read())
            {
                tabla.Append("<div class=\"card\"> <div ><img src=\"" + dr["imagen"].ToString() + "\"@Data.imagen class=\"cardImg\" ID=\"articulo\" runat=\"server\" /> <div class=\"middle\"> CPU: "+ dr["cpu"].ToString() + " </br> RAM: " + dr["ram"].ToString() + " </br> Memoria: " + dr["memoria"].ToString() + " </br> Pantalla: " + dr["pantalla"].ToString() + "</div> </div> </br> ");
        ...
        protected void searchEnter(object sender, EventArgs e)
        {
            ...
            SqlCommand com = new SqlCommand("SELECT * FROM ARTICULO AS art RIGHT JOIN MOVIL AS mov ON art.codigo = mov.codigo WHERE UPPER(nombre) LIKE UPPER('%" + searchBar.Text + "%') OR UPPER(marca) LIKE UPPER('%" + searchBar.Text + "%')", c);
            SqlDataReader dr = com.ExecuteReader();
