...
namespace mobileWeb
{
    public partial class Funda : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand com = new SqlCommand("SELECT * FROM ARTICULO AS art RIGHT JOIN FUNDA AS fun ON art.codigo = fun.codigo", c);
            SqlDataReader dr = com.ExecuteReader();

            while (dr.Read())
            {
                tabla.Append("<div class=\"card\"> <div ><img src=\"" + dr["imagen"].ToString() + "\"@Data.imagen class=\"cardImg\" ID=\"articulo\" runat=\"server\" />  <div class=\"middle\"> Diseño: " + dr["diseño"].ToString() + " </br> Modelo: " + dr["modelo"].ToString() + " </br> Material: " + dr["material"].ToString() + "</div> </div> </br> ");
        ...
        protected void searchEnter(object sender, EventArgs e)
        {
            ...
            SqlCommand com = new SqlCommand("SELECT * FROM ARTICULO AS art RIGHT JOIN FUNDA AS fun ON art.codigo = fun.codigo WHERE UPPER(nombre) LIKE UPPER('%" + searchBar.Text + "%') OR UPPER(marca) LIKE UPPER('%" + searchBar.Text + "%')", c);
            SqlDataReader dr = com.ExecuteReader();
