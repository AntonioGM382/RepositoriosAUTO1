<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OkRegister.aspx.cs" Inherits="mobileWeb.OkRegister" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div dir="auto" class="menu3" style="text-align:center;">
            ...
            <h1 class="msg">
              <span class="text-wrapper">
                ...
                <span class="letters">REGISTRADO</span>
              </span>
            </h1>
